...
<form action="{{ url('admin/mimbar/cari') }}" method="GET">
    ...
    <div class="animated fadeIn">
        ...
        <div class="card">
            <div class="card-header">
                <div class="pull-left">
                    <strong> Mimbar Jum'at Masjid Kota Parepare</strong>
                </div>
                <div class="pull-right">
                    <a href=" {{ url ('admin/mimbar/add') }} " class="btn btn-success btn-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ url('admin/mimbar/edit/'.$item->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-pencil"></i>
                                </a>
                               {{--  <a href="{{ url('admin/berita/showphoto/'.$item->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-image"></i>
                                </a> --}}
                                <form action="{{ url('admin/mimbar/'.$item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('konfirmasi Hapus Data ?')">
                                    @method('delete')
                                    @csrf
